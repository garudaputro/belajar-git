...
<head>
    ...
    <style>
        ...
        .dataTable-table thead tr th a.dataTable-sorter::after,
        .dataTable-table thead tr th a.dataTable-sorter::before {
            right: -10px;
        }
...
<body>
    <div class="container py-10 pb-6">
        ...
        <p class="text-dark text-center mt-10">© eunoya| <a href="https://eunoya.id" target="_blank">eunoya.id</a></p>
    </div>
    <!-- JS -->
    <!-- Bootstrap -->
